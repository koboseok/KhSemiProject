...
<body>
	<div align="center">
		<table class="board">
			...
			<tbody>
				<form action="${contextPath}/jointBoard/update.do" method="post">
				<div class="mb-2">
					...
					<div class="contentArea">
						<tr>
							...
							<td><input type=text id = "jointTitle" class="form-control" name=title size=70
								 placeholder="제목을 입력해 주세요"></td>
						</tr>
						<tr>
							<td style="color: gray">내용</td>
							<td><textarea  id = "jointContent" class="form-control" name=content cols=80
