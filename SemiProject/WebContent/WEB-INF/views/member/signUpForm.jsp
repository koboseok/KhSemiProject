...
<body>
					...
					<div class="row">
						...
						<div class="col-md-7" id="serviceFormWrapper">
							<div class="serviceFormGroup">
								...
								<!-- + 아이콘 -->
								<i class="far fa-plus-square plus-minus plus-icon" id="addServiceForm"></i>
	...
	<script>
		...
		$(document).on("click", ".plus-icon", function(){
			...
			var newForm = $(event.target).parent().clone(true).appendTo($("#serviceFormWrapper"));
