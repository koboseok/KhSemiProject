...
import com.kh.semi.privateBoard.model.service.PrivateBoardService;
...
public class PrivateBoardController extends HttpServlet {
...
//		공통적인 사용을 위한  변수 선언
		...
		String command = uri.substring((contextPath + "/privateBoard").length() );
