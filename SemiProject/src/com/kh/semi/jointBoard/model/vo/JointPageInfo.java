...
public class JointPageInfo {  // 페이징 처리하는 vo
	...
	public JointPageInfo(int currentPage, int listCount) {
		super();
	...
	public JointPageInfo(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
