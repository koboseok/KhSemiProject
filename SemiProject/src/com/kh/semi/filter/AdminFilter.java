/*
  ...
  "/notice/updateForm.do", "/notice/update.do", "/notice/delete.do"} ) public
  class AdminFilter implements Filter {
  
  public AdminFilter() {} public void init(FilterConfig fConfig) throws
  ...
  // 메인 페이지로 강제이동 res.sendRedirect(req.getContextPath());
