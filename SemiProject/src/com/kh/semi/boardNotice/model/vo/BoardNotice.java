package com.kh.semi.boardNotice.model.vo;
...
public class BoardNotice {
	...
	private String memNm; 		// 작성자 닉네임
	private int readCount; 			// 조회수
	private Date noticeCreateDate; 	// 공지사항 생성일
	...
	public String toString() {
		return "BoardNotice [noticeNo=" + noticeNo + ", noticeTitle=" + noticeTitle + ", noticeContent=" + noticeContent
				+ ", memNm=" + memNm + ", readCount=" + readCount + ", noticeCreateDate=" + noticeCreateDate
				+ ", noticeFl=" + noticeFl + "]";
	}
