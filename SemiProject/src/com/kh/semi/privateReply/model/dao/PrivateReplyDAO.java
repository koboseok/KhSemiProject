package com.kh.semi.privateReply.model.dao;
...
public class PrivateReplyDAO {
   ...
   public PrivateReplyDAO() {
       String fileName = Board.class.getResource("/com/kh/semi/sql/reply/PrivateReply-query.xml").getPath();
         try {
            prop = new Properties();
    ...
    * @throws Exception
    */
   public List<PrivateReply> selectList(Connection conn, int parentBoardNo) throws Exception {
      List<PrivateReply> rList = null;
      ...
      try {
         ...
         rList = new ArrayList<PrivateReply>();
    ...
    * @throws Exception
    */
   public int insertReply(Connection conn, PrivateReply reply) throws Exception{
      int result = 0;
 ...
 * @throws Exception
 */
public int updateReply(Connection conn, PrivateReply reply)throws Exception {
